...
namespace CatQL.GraphQL.Client
{
    public interface IGqlClient
    {
        ...
        /// <typeparam name="T">
        /// ResponseType class that must contain a property of the same type that the Query returns
        /// and the Property name must be the same as the query/mutation name.  
        /// </typeparam>
        /// <returns>
